...
def test_around_durable_mode_uses_created_window(mock_memory):
    a = mock_memory.save(
        content="primer hecho del lunes sobre el deploy " * 2,
        title="A",
        created="2026-01-01T10:00:00",
    )
    b = mock_memory.save(
        content="segundo hecho del martes sobre el deploy " * 2,
        title="B",
        created="2026-01-02T10:00:00",
    )
    c = mock_memory.save(
        content="tercer hecho del miércoles sobre el deploy " * 2,
        title="C",
