...
from memo.maintain_compact import (
    _older_id,
    _persist_quality_compact_receipt,
    _prepare_quality_compact_receipt_paths,
    _quality_compact_rollback_ids,
    _read_synthesis_last_run,
    _restore_archived,
    _restore_quality_compact_indexes,  # noqa: F401 — re-exported for tests
    _rollback_quality_compaction,
    _state_path,
    _synthesis_state_path,  # noqa: F401 — re-exported for tests
    _undo_targets,
