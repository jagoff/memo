...
def collect_data(
    ...
    data = {
        ...
        "recall_util": {
            ...
            "composite_score_threshold": recall_health_data["composite_score_threshold"],
            "top_composite_score_rate": recall_health_data["top_composite_score_rate"],
            "strong_hit_rate": recall_health_data["strong_hit_rate"],
            "median_top_composite_score": recall_health_data["median_top_composite_score"],
