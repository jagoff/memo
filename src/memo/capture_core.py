"""Core capture logic: transcript parsing, extraction, deduplication, and quality gates.

This module contains the core machinery for ambient capture:
- Transcript parsing and exchange extraction
- Helper LLM invocation for insight extraction
- Deduplication and near-duplicate detection
- Quality gates and hygiene filters (meta-commentary, generic prefixes)
