...
`memo` (path local: [`/Users/USER/repositories/memo/`](file:///Users/USER/repositories/memo/)) es un MCP local que da memoria persistente backed by Obsidian. Stack 100% local-first, **zero Ollama, zero cloud**:
