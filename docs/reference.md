...
curl -fsSL https://raw.githubusercontent.com/jagoff/memo/v4.9.1/install.sh | MEMO_VERSION=0.6.0 bash
...
curl -fsSL https://raw.githubusercontent.com/jagoff/memo/v4.9.1/install.sh | MEMO_INSTALL_DOWNLOAD_MODELS=no bash

# Force-yes the MLX model download (skip the interactive confirmation).
curl -fsSL https://raw.githubusercontent.com/jagoff/memo/v4.9.1/install.sh | MEMO_INSTALL_DOWNLOAD_MODELS=yes bash
```
