...
SAMPLES: list[ResumeCandidate] = [
    ResumeCandidate(
        ...
        session_id="aa7b84c0",
        title="",
        summary="fix save-gate preset parsing",
        cwd=CWD,
    ...
    ResumeCandidate(
        ...
        session_id="019f51e9",
        title="",
        summary="port BM25 Spanish tokenizer tests",
        cwd=CWD,
        updated_at=_ago(minutes=41),
        status="recent",
    ...
    ResumeCandidate(
        ...
        session_id="7f3c9d10",
        title="",
        summary="trace federation receipt bug",
        cwd=os.path.expanduser("~/repos/synapse"),
        updated_at=_ago(hours=1),
        status="recent",
        resume_command=["gemini", "--resume", "7f3c9d10"],
    ),
    ResumeCandidate(
        agent="devin",
        ...
        session_id="04c1172d",
        title="",
        summary="cross-Mac sync rebase loop",
        cwd=os.path.expanduser("~/repos/memflow"),
    ...
    ResumeCandidate(
        ...
        session_id="2dd1b1d8",
        title="",
        summary="docker CPU-backend smoke test",
        cwd=CWD,
    ...
    ResumeCandidate(
        ...
        session_id="15c89574",
        title="",
        summary="git-sync ahead/behind self-heal",
    ...
    ResumeCandidate(
        ...
        session_id="8b132f30",
        title="",
        summary="reranker head-slice perf win",
        cwd=CWD,
    ...
    ResumeCandidate(
        ...
        session_id="6fab8c90",
        title="",
        summary="eval regression labels update",
        cwd=CWD,
