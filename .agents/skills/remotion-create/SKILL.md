...
Keep the scaffold and add React Markup. Follow [Remotion React Markup Best Practices](../remotion-best-practices/remotion-markup/REFERENCE.md) and [Video Layout Rules](video-layout.md) for video-first layout and text sizing guidance.

## Interactivity Best Practices

By structuring the React Markup following [Remotion Interactivity Best Practices](../remotion-best-practices/remotion-interactivity/REFERENCE.md), you allow the user to make edits in the Studio which write back to code.
