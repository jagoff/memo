...
def _snapshot(args: argparse.Namespace) -> dict[str, object]:
    ...
    if args.attempt_root.exists():
        ...
        initialize_attempt_root(args.attempt_root, args.attempt_id)
    target = resolve_under_attempt(args.attempt_root, relative, args.attempt_id)
